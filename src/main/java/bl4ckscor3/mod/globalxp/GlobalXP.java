...
import bl4ckscor3.mod.globalxp.blockitems.XPBlockItem;
...
public class GlobalXP implements ModInitializer
{
	...
	public void onInitialize()
	{
		...
		Registry.register(Registry.ITEM, XPBlock.ID, new XPBlockItem(XP_BLOCK, new Item.Settings().itemGroup(ItemGroup.MISC)));
